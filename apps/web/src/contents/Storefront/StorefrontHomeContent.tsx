...
import { TeahTreatsBrandStory } from '@/components/TeahTreatsStorefront/TeahTreatsBrandStory';
import { TeahTreatsCategoryMosaic } from '@/components/TeahTreatsStorefront/TeahTreatsCategoryMosaic';
import { TeahTreatsHero } from '@/components/TeahTreatsStorefront/TeahTreatsHero';
import { TeahTreatsMarquee } from '@/components/TeahTreatsStorefront/TeahTreatsMarquee';
import { TeahTreatsNewsletter } from '@/components/TeahTreatsStorefront/TeahTreatsNewsletter';
import { TeahTreatsTestimonials } from '@/components/TeahTreatsStorefront/TeahTreatsTestimonials';
import {
      ...
      <div className="tt-container">
        <div className="tt-section-heading">
          <div>
            ...
            <p className="tt-body">
              TeshTreats keeps bulk orders practical: pick the tray, confirm the details, and get notified when it is ready.
            </p>
          </div>
        </div>
  ...
  return (
    <div>
      ...
      <ProductRail
        ...
        description="A focused selection of TeshTreats favorites customers come back for."

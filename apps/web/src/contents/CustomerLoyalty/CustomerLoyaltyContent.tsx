      ...
      <div className="tt-page-header" style={{ background: 'var(--tt-black)' }}>
        <div className="tt-container">
          ...
          <p className="tt-body" style={{ maxWidth: 560 }}>
            Earn points from simple snack goals and use them on future TeahTreats orders.
          </p>
            ...
            <>
              <div className="tt-panel-elevated" style={{ padding: 24, borderRadius: 16 }}>
                <Group justify="space-between">
                  ...
                  <Badge styles={{ root: { background: 'rgba(184, 147, 62, 0.1)', color: 'var(--tt-gold-light)', border: '1px solid var(--tt-gold-muted)' } }}>Active</Badge>
                </Group>
              </div>
